...
___INFO___
{
  ...
  "description": "GTM server-side tag template for integrating with SignalSight'ss Conversion API Gateway, enabling smooth event forwarding to ad platforms like Facebook, TikTok, Google, and Snapchat.",
  "containerContexts": [
    "SERVER"
  ]
}